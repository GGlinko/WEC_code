...
waves.height = 1:9;                     % Wave Height [m]
waves.period = 1:15;                       % Wave Period [s]
...
%% Body Data
% Flap
body(1) = bodyClass('cy_dataset.h5');      % Initialize bodyClass for Flap
...
% PTO
pto(1) = ptoClass('PTO');                      % Initialize ptoClass for PTO1
pto(1).stiffness = 0;                           % PTO Stiffness Coeff [Nm/rad]
pto(1).damping = 28000;                         % PTO Damping Coeff [Nsm/rad]
