###########################################################################
## Makefile generated for component 'PA'. 
## 
## Makefile     : PA.mk
## Generated on : Wed May 22 09:18:28 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PA_acc.mexw64
...
START_DIR                 = D:/CAPYTA~1/wecSim/SINGLE~1/REGULA~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = PA_comp.rsp
CMD_FILE                  = PA.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PA_acc.mexw64
...
DEFINES_STANDARD = -DMODEL=PA -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/accel/PA/PA_acc.c $(START_DIR)/slprj/accel/PA/PA_acc_data.c $(START_DIR)/slprj/accel/PA/rtGetInf.c $(START_DIR)/slprj/accel/PA/rtGetNaN.c $(START_DIR)/slprj/accel/PA/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = PA_acc.obj PA_acc_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj c_mexapi_version.obj
...
PA_acc.obj : $(START_DIR)/slprj/accel/PA/PA_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PA_acc_data.obj : $(START_DIR)/slprj/accel/PA/PA_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/accel/PA/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/accel/PA/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/PA/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
